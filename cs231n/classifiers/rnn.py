...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        h0, projection_cache = affine_forward(features, W_proj, b_proj)
        x, embedding_cache = word_embedding_forward(captions_in, W_embed)
        if self.cell_type == 'rnn': h, cache = rnn_forward(x, h0, Wx, Wh, b)
        else: h, cache = lstm_forward(x, h0, Wx, Wh, b)
        ...
        _, grads["W_proj"], grads["b_proj"] = affine_backward(dh0, projection_cache)
